...
export const players = [
  {
    ...
    modifier: 0,
    condition: "roll",
    outcomes:[{type:"max",target:6,play:"1B"},{type:"max",target:4,play:"SAC"}],
    bat(dice) {
  ...
  },
  {
    ...
    modifier: 0,
    condition: "roll",
    outcomes:[{type:"sum",target:8,play:"1B"}],
    bat(dice) {
  ...
  },
  {
    ...
    modifier: 0,
    condition: "roll",
    outcomes:[{type:"even",count:3,play:"2B"},{type:"odd",count:3,play:"BB"}],
    bat(dice) {
  ...
  },
  {
    ...
    reroll: 0,
    modifier: 0,
    outcomes:[{type:"unequal",count:2,play:"1B"},{type:"unequal",count:3,play:"2B"}],
    team: "CLE",
    condition: "roll"
  },
  {
